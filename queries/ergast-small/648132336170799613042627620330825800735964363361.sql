...
AND (s1.status LIKE ('Did not qualify'))
AND (res1.position <= '5.0')
AND (res1."positionOrder" <= '5')
AND (s2.status NOT LIKE ('Wheel'))
AND (res2.position > '15.0')
AND (res2."positionOrder" <= '20')
