...
AND (s1.status LIKE ('+7 Laps'))
AND (res1.position > '19.0')
AND (res1."positionOrder" <= '21')
AND (s2.status NOT LIKE ('Electrical'))
AND (res2.position > '16.0')
AND (res2."positionOrder" <= '17')
