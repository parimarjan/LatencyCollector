/*+ Rows(mii1 mii2 t mi1 kt it1 it3 it4 mk #35058) Rows(k #1) Rows(mii1 mii2 t mi1 kt it1 it3 it4 #1010) Rows(mk #35) Rows(mii1 mii2 t mi1 kt it1 it3 #1010) Rows(it4 #1) Rows(mii1 mii2 t mi1 kt it1 #1010) Rows(it3 #1) Rows(mii1 mii2 t mi1 kt #1010) Rows(it1 #1) Rows(mii1 mii2 t mi1 #1164) Rows(kt #1) Rows(mii1 mii2 t #1141) Rows(mi1 #1) Rows(mii1 mii2 #1247) Rows(t #1) Rows(mii1 #21626) Rows(mii2 #0) NestLoop(it1 it3 it4 k kt mi1 mii1 mii2 mk t) NestLoop(it1 it3 it4 kt mi1 mii1 mii2 mk t) NestLoop(it1 it3 it4 kt mi1 mii1 mii2 t) NestLoop(it1 it3 kt mi1 mii1 mii2 t) NestLoop(it1 kt mi1 mii1 mii2 t) NestLoop(kt mi1 mii1 mii2 t) NestLoop(mi1 mii1 mii2 t) NestLoop(mii1 mii2 t) NestLoop(mii1 mii2)  Leading((((((((((mii1 mii2) t) mi1) kt) it1) it3) it4) mk) k)) IndexOnlyScan(k) IndexScan(mk) SeqScan(it4) SeqScan(it3) SeqScan(it1) IndexScan(kt) IndexScan(mi1) IndexScan(t) BitmapScan(mii1) IndexScan(mii2)   */ explain (format json) SELECT COUNT(*)
