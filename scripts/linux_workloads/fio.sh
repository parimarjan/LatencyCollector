...
sudo fio --filename=./test --rw=read   --ioengine=libaio --numjobs=1 --group_reporting --name=read  --size=2gb
...
sudo fio --filename=./test --rw=write   --ioengine=libaio --numjobs=1 --group_reporting --name=write  --size=2gb
...
sudo fio --filename=./test --rw=trim   --ioengine=libaio --numjobs=1 --group_reporting --name=trim  --size=2gb
...
sudo fio --filename=./test --rw=randread   --ioengine=libaio --numjobs=1 --group_reporting --name=randread  --size=2gb
...
sudo fio --filename=./test --rw=randwrite   --ioengine=libaio --numjobs=1 --group_reporting --name=randwrite  --size=2gb
...
sudo fio --filename=./test --rw=randtrim   --ioengine=libaio --numjobs=1 --group_reporting --name=randtrim  --size=2gb
...
sudo fio --filename=./test --rw=rw   --ioengine=libaio --numjobs=1 --group_reporting --name=rw  --size=2gb
...
sudo fio --filename=./test --rw=readwrite   --ioengine=libaio --numjobs=1 --group_reporting --name=readwrite  --size=2gb
...
sudo fio --filename=./test --rw=randrw   --ioengine=libaio --numjobs=1 --group_reporting --name=randrw  --size=2gb
...
sudo fio --filename=./test --rw=trimwrite   --ioengine=libaio --numjobs=1 --group_reporting --name=trimwrite  --size=2gb
