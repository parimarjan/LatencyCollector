...
#ffmpeg -y -nostdin -i input.mp4 -vn -acodec copy output-audio.aac
#ffmpeg -y -nostdin -i input.mp4 -codec:v libx264 -codec:a libmp3lame output.mkv
#ffmpeg -y -nostdin -i input.mp4 -vf scale=640:480,setsar=1 output.mp4
#ffmpeg -y -nostdin -i input.mp4 -r 30 output.mp4
#ffmpeg -y -nostdin -i input.mp4 -aspect 1.7777 output.mp4
#rm input.mp4
